...
export const modules=[
  {
    id:'climate-foundations',number:'01',week:'Weeks 1–2',title:'Understanding Climate Change',
    ...
    lessons:[
      {id:'climate-vs-weather',title:'Climate is not weather',minutes:8,body:[
        'Weather describes short-term conditions such as today’s rainfall or temperature. Climate describes patterns observed over much longer periods.',
      ...
      ],takeaway:'Climate is a long-term pattern. Climate change is a sustained shift in that pattern—not a single hot day, flood or storm.'},
      ...
      ],takeaway:'Today’s rapid warming is primarily driven by human-caused greenhouse-gas emissions.'},
      ...
      {id:'mitigation-adaptation',title:'Mitigation, adaptation and resilience',minutes:10,body:[
        ...
        'Adaptation responds to impacts that are already happening or expected—for example drought-resilient farming, flood preparedness or heat-health planning.',
    ...
    quiz:[
      {q:'Which statement best describes climate?',options:['Today’s temperature','Long-term patterns of weather','A single flood event','Only rainfall'],answer:1},
    ...
    assignment:{title:'Assignment 01 · Climate in my context',prompt:'Choose one climate-related change or risk visible in your community or country. In 250–400 words, explain what is changing, who is affected, and one adaptation or mitigation response that could help.'}
  },
  {
    ...
    summary:'Understand how gender, inequality and access to resources shape climate impacts—and what inclusive climate solutions look like.',
  ...
  },
  {
    ...
    lessons:[
      ...
      ],takeaway:'Climate governance is a network of decision spaces—not one institution or conference.'},
      ...
      {id:'ndcs',title:'What is an NDC?',minutes:9,body:[
        'A Nationally Determined Contribution, or NDC, sets out a country’s climate commitments under the Paris Agreement.',
        ...
        'Knowing your country’s NDC can help you connect a community project, advocacy campaign or professional role to national climate priorities.'
      ...
      {id:'participation',title:'Finding your entry point',minutes:10,body:[
        'Participation can include public consultations, local planning, youth or women’s networks, civil-society coalitions, research, journalism, professional associations and direct engagement with institutions.',
    ...
    quiz:[
      {q:'What is an NDC?',options:['A private company plan','A country’s climate commitments under the Paris Agreement','A COP attendance badge','A climate degree'],answer:1},
  ...
  {
    id:'advocacy-digital',number:'04',week:'Weeks 5–6',title:'Climate Advocacy & Digital Innovation',
    ...
    lessons:[
      ...
      {id:'digital-advocacy',title:'Digital advocacy that moves beyond posting',minutes:10,body:[
        ...
        'Track indicators that matter: sign-ups, meeting requests, policy responses, participation, commitments or behaviour—not only likes.'
      ...
      {id:'ai',title:'Using AI responsibly in climate work',minutes:11,body:[
        ...
        'Use technology to extend human judgement—not replace accountability.'
    ...
    assignment:{title:'Assignment 04 · Make climate understandable',prompt:'Create a short climate message for a specific audience (150–250 words or a one-minute script). State the audience, the evidence behind your message and the action you want them to take.'}
  },
  {
    id:'leadership-pathways',number:'05',week:'Weeks 7–8',title:'Leadership & Professional Pathways',
    ...
    lessons:[
      ...
      ],takeaway:'You do not need one job called “climate leader.” You need a useful skill applied to climate-relevant problems.'},
...
export const resources=[
  {title:'UNFCCC — Climate Action',type:'External reference',url:'https://unfccc.int/'},
