...
function ManagerOperations({snapshot,session,onReload,viewer,view='overview'}){
 const[busy,setBusy]=useState('');const[msg,setMsg]=useState('');const[form,setForm]=useState({learner_id:'',action_type:'reminder',subject:'',message:''});const[reviewFilter,setReviewFilter]=useState('all');const[reviewDrafts,setReviewDrafts]=useState({});const[spotlightWeek,setSpotlightWeek]=useState('module-01');const[spotlightCategory,setSpotlightCategory]=useState('emerging_leadership');const[spotlightNote,setSpotlightNote]=useState('');const[spotlightReviewSource,setSpotlightReviewSource]=useState('all');const[spotlightOutcome,setSpotlightOutcome]=useState('all');const[spotlightCommentType,setSpotlightCommentType]=useState('all');const[spotlightLovedOnly,setSpotlightLovedOnly]=useState(false);
