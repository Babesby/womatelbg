...
const MODULE_VIDEO_URLS={
  ...
  '05':'https://share.synthesia.io/embeds/videos/0eb25129-d710-4b4b-88b1-5a995276e2eb'
};
...
export const modules=canopyModules2026.map((m)=>({
  ...
  assignment:{
    ...
    practicalTitle:m.assignment.practicalTitle,
    practicalBrief:m.assignment.practicalBrief,
    practicalInstructions:m.assignment.practicalInstructions,
    practicalLinkLabel:m.assignment.practicalLinkLabel,
    practicalHref:m.assignment.practicalHref,
    practicalActionLabel:m.assignment.practicalActionLabel,
    exampleEmbed:m.assignment.exampleEmbed,
    exampleLabel:m.assignment.exampleLabel,
    exampleImages:m.assignment.exampleImages,
    portfolioLabel:m.assignment.portfolioLabel,
    portfolioSummary:m.assignment.portfolioSummary,
